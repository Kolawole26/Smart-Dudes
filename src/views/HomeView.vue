...
<template>
    <main class=" bg-B-purple text-center lg:h-screen">
        <div class=" md:px-14 px-10  pb-7 lg:pb-0 ">
            ...
            <div class=" lg:flex justify-between mx-auto  ">
              ...
              <div @click="shareData" class="bg-white rounded-2xl md:px-24 px-10 text-center btn pt-10 pb-2 mb-10 lg:mb-0 ">
                  ...
                  <div @click="shareDataMovies" class="bg-white rounded-2xl md:px-24 px-10 text-center btn pt-10 pb-2 mb-10 lg:mb-0 ">
                  ...
                  <div @click="shareDataMusic" class="bg-white rounded-2xl md:px-24 px-10 text-center btn pt-12 pb-2 mb-10 lg:mb-0 ">
                  ...
                  <div @click="shareDataBooks" class="bg-white rounded-2xl md:px-24 px-10 text-center btn pt-12 pb-2 mb-10 lg:mb-0 "> 
